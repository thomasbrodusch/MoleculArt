...
*/
	         public boolean connectServer(){
	         	  ...
	         	  try{
	         	      ...
	         	      //return true;
	         	   }catch(Exception e){ System.err.println("[ ERROR ] - HTTP RCSB.org server is unreachable ###\n"); }
	         	 return true;
	         	         }
 ...
 */
	         ...
	         public void execDownload(){
	        	 ...
	        	 try{
	        	 /*
	              * Prepare un "buffered file writer" pour ecrire
	              * sur "out" le fichier du website.
	              */
	             FileOutputStream writer = new FileOutputStream("tmp/"+this.filename);
	             byte[] buffer = new byte[153600];
	             int totalBytesRead = 0;
	             int bytesRead = 0;
	      
	             System.out.println("[ INFO ] - reading file 150KB blocks at a time. ###\n");
	             ...
	             System.out.println("[ INFO ] - download done. 'tmp/"+this.filename+"' "+(new Integer(totalBytesRead).toString())+" bytes read ("+(new Long(endTime - startTime).toString())+"ms). ###\n");
	             writer.close();
	             reader.close();
	          }
